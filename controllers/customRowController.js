...
const createNewCustomRowMSSQL = async (req, res) => {
...
const getAllCustomRowMSSQL = async (req, res) => {
...
const getSingleCustomRowMSSQL = async (req, res) => {
...
const deletePosterMSSQL = async (req, res) => {
...
const createPosterMSSQL = async (req, res) => {
  ...
  let newPoster = await pool
    ...
    .input('input_posterURL_ATV', sql.VarChar, `/uploads/${atvPosterFilename}`)
    .input('input_createdBy', sql.Int, req.user.userId)
...
const deleteCustomRowMSSQL = async (req, res) => {
  const { rowId } = req.params;
...
const updateCustomRowMSSQL = async (req, res) => {
  const { rowId } = req.params;

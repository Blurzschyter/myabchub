...
const registerMSSQL = async (req, res, next) => {
  ...
  //create jwt token
  const token = jwt.sign({ userId: userObj.user_id }, process.env.JWT_SECRET, {
...
const loginMSSQL = async (req, res) => {
  // res.send('login user');
...
const updateUserMSSQL = async (req, res) => {
